...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        #saver = tf.train.import_meta_graph('/home/data/vision7/azlu/imdb_real_80+/my_models/my_model_.ckpt.meta')
        #saver.restore(sess, "/home/data/vision7/azlu/imdb_real_80+/my_models/my_model_.ckpt")
        ...
        vgg = vgg16(imgs, '/home/data/vision7/azlu/vgg16_weights.npz', sess)
        ...
        for j in range(70):
            ...
            for i in range(1,num_batches+1):
                ...
                img_batch=np.load('/home/data/vision7/azlu/imdb_real_80+/train_set/images/img_tr_batch_{0}.npz'.format(i))
                image_data = img_batch['images']

                #This part loads in the label data in corresponding batches, wherever they may be
                lbl_batch=np.load('/home/data/vision7/azlu/imdb_real_80+/train_set/labels/label_tr_batch_{0}.npz'.format(i))
            ...
            for i in range(1, 117):    
                ...
                img_batch=np.load('/home/data/vision7/azlu/imdb_real_80+/val_set/images/img_tr_batch_{0}.npz'.format(i))
                image_data = img_batch['images']

                lbl_batch=np.load('/home/data/vision7/azlu/imdb_real_80+/val_set/labels/label_tr_batch_{0}.npz'.format(i))
                label_data = lbl_batch['labels']

                #The per batch accuracy along the way
                print('Batch Accuracy:', repr(sess.run(accuracy, feed_dict={imgs: image_data, lbls: label_data})))

                #Adjusting total accuracy parameters along the way
                sum_of_acc += sess.run(accuracy, feed_dict={imgs: image_data, lbls: label_data})
            ...
            savePath=saver.save(sess, '/home/data/vision7/azlu/imdb_real_80+/my_models/my_model_'+str(j)+'.ckpt')
